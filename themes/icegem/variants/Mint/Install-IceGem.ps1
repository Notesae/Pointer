...
Write-Host "IceGem 4.5 Mint installer | Source: $SourceRoot"
...
try {
    ...
    if($Action -in @('Restore','Uninstall')){
        ...
        $linkExpected=@{
            '32'='6FBF6ADE69A3BFA3D305BEBABE5A559F36570AEFF30A0AAACAFD801E199ECB2A'
            '48'='85EB9BFF2BC349736B3C97B660C115D22A97A43DE4EFD6EAF24911B059A04222'
            '64'='28EA939BA408ACD7D70C0B036435BF5C65AFC208C16F7AB7E39B570E5FA7EF86'
            'multi'='40B0964F5BAFD42116C8B56E9C3E2FD685CEAAA09B2EDEE014218E8232757A5B'
        }
        ...
        if((Get-FileHash -LiteralPath $linkSource -Algorithm SHA256).Hash -ne $linkExpected[$Size]){
            throw 'Link resource is not the 4.5 Mint rotating crystal. Extract the complete versioned package into a NEW folder.'
        }
        $before=Capture-Settings
        ...
        Write-Host '[VERIFIED] Link Select = 4.5 Mint ROTATING CRYSTAL (file + registry).' -ForegroundColor Cyan
