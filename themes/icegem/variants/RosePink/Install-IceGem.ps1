...
try {
    ...
    if($Action -in @('Restore','Uninstall')){
        ...
        $linkExpected=@{
            '32'='2E6854A9FE60008B8B248D3A65AEDB2465D5F31A77AFE6FA85B972292D1379DD'
            '48'='28428C164E22AD293E294DD6F7F537B27549D04F9D23669B2560FE998FA0C214'
            '64'='DBE537D9C14B0F0A848AD7D882F700C88841AC7E2F1325FD907C565D6AF8D1DF'
            'multi'='B95948DB38A1125398B2E00E08D2E7846AF93337B772D119EE0E4259D24EF8EB'
        }
        ...
        $destination=Join-Path $root "$stamp-RosePink-$Size"
        ...
        try {
            ...
            $key.SetValue('',"IceGem RosePink $Mode ($Size)",[Microsoft.Win32.RegistryValueKind]::String)
